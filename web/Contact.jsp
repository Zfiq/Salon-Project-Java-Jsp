                            ...
                            <%
                                ...
                                if (request.getParameter("submit") != null) {
                                    ...
                                    try {
                                        javaEmail.sendEmail();
                                        status = "success";
                                        message = "<div class='message' style='color:white;font-weight:bold; font-size:25px;font-style:italic;'><br>Your email sent Successfully!</br>Thanks for your E-mail we will get back to you soon as possible.</div>";
                                        response.sendRedirect("Contact-Status.jsp");
                                        session.setAttribute("message", message);
                                    } catch (Exception e) {
                                        status = "error";
                                        message = "<div class='message' style='color:red; font-size:20px; font-style:italic'> <Error in Sending Email! </div>";
                                    }
                                }
                            %>
                            ...
                            <form action="" class="p-5 bg-white">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="subject" id="subject" name="subject" class="form-control" required="true">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="message" id="message" cols="30" rows="7" class="form-control" required="true" placeholder="Write your notes or questions here..."></textarea>
                                    </div>
                                </div>

                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <input type="submit" name="submit" value="Send Message" class="btn btn-primary py-2 px-4 text-white"  onclick="PersonName()" >
                                    </div>
                                </div>
                                <%
                                    if (null != message) {
                                        out.println("<div class='" + status + "' style='color:green;'>"
                                                + message + "</div>");
                                    }
                                %>
