            ...
            <div class="row align-items-center">
                ...
                <div class="message" style="position:fixed; margin-left: 45%; margin-top: 8%">
                    ...
                    <%
                        ...
                        out.println("<div class='name' style='color:green; font-size:25px;font-style:italic;'>Thank you : " + name + "</div>");
                ...
                <div class="message" style="position:fixed; margin-left: 45%; margin-top: 10%">
